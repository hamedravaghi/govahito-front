...
export const phoneNumberValidation = Yup.object().shape({
     ...
     acceptRole: Yup.bool().required("پذیرفتن قوانین گواهیتو برای ورود به نرم افزار الزامی است").oneOf([true], "پذیرفتن قوانین گواهیتو برای ورود به نرم افزار الزامی است")
})
